...
export interface IVersionService {
     ...
     */
    associate(options: AssociateOptions, nestedTransaction?: boolean): Promise<void>
     ...
     */
    unassociate(options: UnAssociateOptions, nestedTransaction?: boolean): Promise<void>
